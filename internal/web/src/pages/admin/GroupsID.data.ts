...
export const getAdminGroupsIDPage = cache((input: GetAdminGroupIDPageReq) => useClient().admin.getAdminGroupIDPage(input).then((req) => req.response), "getAdminGroupIDPage")
