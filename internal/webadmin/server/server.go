...
func (w Server) Register(e *echo.Echo) {
	...
	g.GET("/dahua/devices/create", w.DahuaDevicesCreate)
	g.GET("/dahua/devices/file-cursors", w.DahuaDevicesFileCursors)
	g.GET("/dahua/events", w.DahuaEvents)
	g.GET("/dahua/events/:id/data", w.DahuaEventsIDData)
	g.GET("/dahua/events/live", w.DahuaEventsLive)
	g.GET("/dahua/events/rules", w.DahuaEventsRules)
	g.GET("/dahua/events/stream", w.DahuaEventStream)
	g.GET("/dahua/files", w.DahuaFiles)
	g.GET("/dahua/files/:id/thumbnail", w.DahuaFilesIDThumbnail)
	g.GET("/dahua/snapshots", w.DahuaSnapshots)
	g.GET("/dahua/storage", w.DahuaStorage)
	g.GET("/dahua/storage/destinations/:id", w.DahuaStorageDestinationsID)
	g.GET("/dahua/storage/destinations/create", w.DahuaStorageDestinationsCreate)
	g.GET("/dahua/streams", w.DahuaStreams)
	g.PATCH("/dahua/devices/streams/:id", w.DahuaDevicesStreamsIDPATCH)
	g.POST("/dahua/devices", w.DahuaDevicesPOST)
	g.POST("/dahua/devices/:id/update", w.DahuaDevicesUpdatePOST)
	g.POST("/dahua/devices/create", w.DahuaDevicesCreatePOST)
	g.POST("/dahua/devices/file-cursors", w.DahuaDevicesFileCursorsPOST)
	g.POST("/dahua/events/rules", w.DahuaEventsRulePOST)
	g.POST("/dahua/events/rules/create", w.DahuaEventsRulesCreatePOST)
	g.POST("/dahua/files", w.DahuaFilesPOST)
	g.POST("/dahua/files/:id/download", w.DahuaFilesIDDownloadPOST)
	g.POST("/dahua/files/download", w.DahuaFilesDownloadPOST)
	g.POST("/dahua/storage/destinations", w.DahuaStorageDestinationsPOST)
	g.POST("/dahua/storage/destinations/:id", w.DahuaStorageDestinationsIDPOST)
	g.POST("/dahua/storage/destinations/:id/test", w.DahuaStorageDestinationsIDTestPOST)
	g.POST("/dahua/storage/destinations/create", w.DahuaStorageDestinationsCreatePOST)
}
