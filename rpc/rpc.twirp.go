...
type User interface {
	...
	GetDevicesPage(context.Context, *google_protobuf.Empty) (*GetDevicesPageResp, error)
...
func (c *userProtobufClient) GetDevicesPage(ctx context.Context, in *google_protobuf.Empty) (*GetDevicesPageResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "GetDevicesPage")
	caller := c.callGetDevicesPage
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *google_protobuf.Empty) (*GetDevicesPageResp, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*google_protobuf.Empty)
					if !ok {
...
func (c *userProtobufClient) callGetDevicesPage(ctx context.Context, in *google_protobuf.Empty) (*GetDevicesPageResp, error) {
...
func (c *userProtobufClient) GetDeviceStatus(ctx context.Context, in *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "GetDeviceStatus")
	caller := c.callGetDeviceStatus
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetDeviceStatusReq)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*GetDeviceStatusReq) when calling interceptor")
					}
					return c.callGetDeviceStatus(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetDeviceStatusResp)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*GetDeviceStatusResp) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *userProtobufClient) callGetDeviceStatus(ctx context.Context, in *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
...
func (c *userJSONClient) GetDevicesPage(ctx context.Context, in *google_protobuf.Empty) (*GetDevicesPageResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "GetDevicesPage")
	caller := c.callGetDevicesPage
...
func (c *userJSONClient) callGetDevicesPage(ctx context.Context, in *google_protobuf.Empty) (*GetDevicesPageResp, error) {
	out := new(GetDevicesPageResp)
	ctx, err := doJSONRequest(ctx, c.client, c.opts.Hooks, c.urls[1], in, out)
	if err != nil {
		twerr, ok := err.(twirp.Error)
...
func (c *userJSONClient) GetDeviceStatus(ctx context.Context, in *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "GetDeviceStatus")
	caller := c.callGetDeviceStatus
...
func (c *userJSONClient) callGetDeviceStatus(ctx context.Context, in *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
	out := new(GetDeviceStatusResp)
...
func (s *userServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "GetDeviceStatus":
		s.serveGetDeviceStatus(ctx, resp, req)
		return
...
func (s *userServer) serveGetDevicesPageJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *google_protobuf.Empty) (*GetDevicesPageResp, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*google_protobuf.Empty)
					if !ok {
...
func (s *userServer) serveGetDeviceStatus(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetDeviceStatusJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetDeviceStatusProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *userServer) serveGetDeviceStatusJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetDeviceStatus")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(GetDeviceStatusReq)
	unmarshaler := protojson.UnmarshalOptions{DiscardUnknown: true}
	if err = unmarshaler.Unmarshal(rawReqBody, reqContent); err != nil {
		s.handleRequestBodyError(ctx, resp, "the json request could not be decoded", err)
		return
	...
	handler := s.User.GetDeviceStatus
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetDeviceStatusReq) (*GetDeviceStatusResp, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*GetDeviceStatusReq)
					if !ok {
					...
					return s.User.GetDeviceStatus(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*GetDeviceStatusResp)
	...
	// Call service method
	var respContent *GetDeviceStatusResp
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = handler(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *GetDeviceStatusResp and nil error while calling GetDeviceStatus. nil responses are not supported"))
		return
	}
...
func (s *userServer) serveGetDeviceStatusProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetDeviceStatus")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
