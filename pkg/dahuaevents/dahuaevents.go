...
const (
	CodeCrossLineDetection    Code = "CrossLineDetection"
	CodeCrossRegionDetection  Code = "CrossRegionDetection"
	CodeFaceDetection         Code = "FaceDetection"
	CodeIntelliFrame          Code = "IntelliFrame"
	CodeInterVideoAccess      Code = "InterVideoAccess"
	CodeLeFunctionStatusSync  Code = "LeFunctionStatusSync"
	CodeLeftDetection         Code = "LeftDetection"
	CodeLoginFailure          Code = "LoginFailure"
	CodeManNumDetection       Code = "ManNumDetection"
	CodeNTPAdjustTime         Code = "NTPAdjustTime"
	CodeNewFile               Code = "NewFile"
	CodeNumberStat            Code = "NumberStat"
	CodeQueueNumDetection     Code = "QueueNumDetection"
	CodeReboot                Code = "Reboot"
	CodeRtspSessionDisconnect Code = "RtspSessionDisconnect"
	CodeSceneChange           Code = "SceneChange"
	CodeSmartMotionHuman      Code = "SmartMotionHuman"
	CodeStorageChange         Code = "StorageChange"
	CodeTakenAwayDetection    Code = "TakenAwayDetection"
	CodeTimeChange            Code = "TimeChange"
