...
// --
// Code generated by webrpc-gen@v0.12.1 with golang generator. DO NOT EDIT.
//
...
func WebRPCSchemaHash() string {
	return "a7305c73471c25d5a68605727245e84b8bcb24c0"
}
...
type AuthService interface {
	...
	Login(ctx context.Context, usernameOrEmail string, password string) (*User, string, error)
}
...
func (s *authServiceServer) serveLoginJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, ret1, err = s.AuthService.Login(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 *User  `json:"user"`
