...
// 		wg.Add(1)
// 		go func(device models.DahuaDevice, conn dahua.Conn) {
// 			client := dahua.NewClient(conn)
//
// 			res, err := func() (string, error) {
// 				res, err := dahuarpc.SendRaw[json.RawMessage](ctx, client.RPC, dahuarpc.
// 					New(c.Method).
// 					Params(params).
// 					Object(c.Object))
// 				if err != nil {
...
// 				return string(b), nil
// 			}()
// 			prefix := fmt.Sprintf("id=%d name=%s", conn.ID, device.Name)
// 			if err != nil {
...
// 			}
//
// 			client.RPC.Close(context.Background())
// 			wg.Done()
// 		}(device)
// 	}
// 	wg.Wait()
